...
PrivateJainSipCallConnector.prototype.close =function(){
    ...
    if(this.sipCallState!=undefined)
    {
        ...
        {
            console.error("PrivateJainSipCallConnector:close(): caught exception:"+exception);
            this.resetSipContext();
            this.clientConnector.removeCallConnector(this.sipCallId);
            // Notify closed event
            this.webRTCommCall.onPrivateCallConnectorCallClosedEvent();
...
PrivateJainSipCallConnector.prototype.reject =function(){
    ...
    if(this.sipCallState==this.SIP_INVITED_INITIAL_STATE)
    {
        ...
        {       
            console.error("PrivateJainSipCallConnector:reject(): caught exception:"+exception);
        }       
        this.close();
    }
    else
...
PrivateJainSipCallConnector.prototype.processInvitingSipRequestEvent =function(requestEvent){
    ...
    else if(this.sipCallState==this.SIP_INVITING_ACCEPTED_STATE)
    {
        if(requestMethod=="BYE")  
        {
            ...
            {
                console.error("PrivateJainSipCallConnector:processInvitingSipRequestEvent(): caught exception exception:"+exception);  
            }
...
PrivateJainSipCallConnector.prototype.processInvitedSipRequestEvent =function(requestEvent){
    ...
    if(this.sipCallState==this.SIP_INVITED_INITIAL_STATE)
    {
        if(requestMethod=="INVITE")  
        {
            ...
            {
                console.error("PrivateJainSipCallConnector:processInvitedSipRequestEvent(): caught exception, exception:"+exception);  
            }
...
PrivateJainSipCallConnector.prototype.processInvitedSipResponseEvent =function(responseEvent){
    ...
    else if(this.sipCallState==this.SIP_INVITED_LOCAL_HANGINGUP_STATE)
    {
        if(statusCode==407)
        {
            ...
            {
                console.error("PrivateJainSipCallConnector:processInvitedSipResponseEvent(): caught exception, exception:"+exception);  
                this.close();
            }
        }
        else
...
PrivateJainSipClientConnector.prototype.SIP_REFRESH_TIMEOUT_MS=180000;
            ...
            if(this.openedFlag==false)
            {
                if(this.checkConfiguration(configuration)==true)
                {
                    ...
                    if(this.configuration.sipUriContactParameters)
                    {
                        ...
                        {
                          console.error("PrivateJainSipClientConnector:open(): caught exception:"+exception);   
                        }
                    }
...
PrivateJainSipClientConnector.prototype.close=function(){
    ...
    try
    {
        ...
        console.error("PrivateJainSipClientConnector:close(): caught exception:"+exception);
        throw exception;  
    }   
}
...
PrivateJainSipClientConnector.prototype.createPrivateCallConnector=function(webRTCommCall, sipCallId){
    ...
    try
    {
        ...
        console.error("PrivateJainSipClientConnector:createPrivateCallConnector(): caught exception:"+exception);
        throw exception;  
    }   
}
...
PrivateJainSipClientConnector.prototype.checkConfiguration=function(configuration){
    ...
    try
    {
        ...
        console.error("PrivateJainSipClientConnector:checkConfiguration(): caught exception:"+exception);
        return false;  
    }  
}  
...
PrivateJainSipClientConnector.prototype.processConnected=function(){
    ...
    try
    {
        ...
        this.reset();
        this.webRTCommClient.onPrivateClientConnectorOpenErrorEvent();
        console.error("PrivateJainSipClientConnector:processConnected(): caught exception:"+exception);
    } 
}   
...
PrivateJainSipClientConnector.prototype.processDisconnected=function(){
    ...
    { 
        ...
        console.error("PrivateJainSipClientConnector:processDisconnected(): caught exception:"+exception);
    }   
}
...
PrivateJainSipClientConnector.prototype.processConnectionError=function(error){
    ...
    try
    {
        ...
        console.error("PrivateJainSipClientConnector:processConnectionError(): caught exception:"+exception);  
    }   
}
...
PrivateJainSipClientConnector.prototype.processRequest=function(requestEvent){
    ...
    try
    {
        ...
        console.error("PrivateJainSipClientConnector:processRequest(): caught exception:"+exception);  
    }   
}  
...
PrivateJainSipClientConnector.prototype.processResponse=function(responseEvent){
    ...
    try
    {
        ...
        console.error("PrivateJainSipClientConnector:processResponse(): caught exception:"+exception);  
    }  
}
...
PrivateJainSipClientConnector.prototype.processTimeout=function(timeoutEvent){
    ...
    try
    {
        ...
        console.error("PrivateJainSipClientConnector:processTimeout(): caught exception:"+exception);  
    }  
}
...
PrivateJainSipClientConnector.prototype.onSipRegisterTimeout=function(){
    ...
    {  
        ...
        console.error("PrivateJainSipClientConnector:onSipRegisterTimeout(): caught exception:"+exception);
    }  
}
            ...
            if(this.checkConfiguration(configuration))
            {
                if(this.isOpened()==false)
                {
                    try
                    {
                        ...
                        console.error("WebRTCommCall:open(): caught exception:"+exception);
                        setTimeout(function(){
                            try {
                            ...
                            {
                                console.error("WebRTCommCall:onPrivateCallConnectorCallOpenErrorEvent(): caught exception in listener:"+exception);    
                            }
                        },1);
            ...
            if(this.checkConfiguration(configuration))
            {
                ...
                if(this.isOpened()==false)
                {
                    try
                    {
                        ...
                        console.error("WebRTCommCall:accept(): caught exception:"+exception);
                        // Close properly the communication
                        try {
                            this.close();
                        } catch(e) {} 
...
WebRTCommCall.prototype.reject =function(){
    ...
    if(this.webRTCommClient.isOpened())
    {
        ...
        {
            console.error("WebRTCommCall:reject(): caught exception:"+exception);
            // Close properly the communication
            try {
                this.close();
            } catch(e) {}    
    ...
    if(this.webRTCommClient.isOpened())
    {
        if(this.isOpened())
        {
            if(this.messageChannel && this.messageChannel.readyState=="open")
            {
                ...
                {
                    console.error("WebRTCommCall:sendMessage(): caught exception:"+exception);
                    throw "WebRTCommCall:sendMessage(): caught exception:"+exception; 
                }
            }
            else
            {
...
WebRTCommCall.prototype.onPrivateCallConnectorRemoteSdpAnswerEvent=function(remoteSdpAnswer){
    ...
    {
        console.error("WebRTCommCall:onPrivateCallConnectorRemoteSdpAnswerEvent(): caught exception:"+exception); 
        throw exception;  
    } 
} 
...
WebRTCommCall.prototype.onPrivateCallConnectorCallOpenedEvent=function()
{
    ...
    if(this.webRTCommClient.eventListener.onWebRTCommCallOpenEvent)
    {
        ...
        setTimeout(function(){
            ...
            {
                console.error("WebRTCommCall:onPrivateCallConnectorCallOpenedEvent(): caught exception in listener:"+exception);    
            }
        },1);
    }
}
...
WebRTCommCall.prototype.onPrivateCallConnectorCallHangupEvent=function()
{
    ...
    if(this.webRTCommClient.eventListener.onWebRTCommCallHangupEvent)
    {
        ...
        setTimeout(function(){
            ...
            {
                console.error("WebRTCommCall:onPrivateCallConnectorCallHangupEvent(): caught exception in listener:"+exception);    
            }
        },1);
    }  
}
...
WebRTCommCall.prototype.onRtcPeerConnectionErrorEvent=function(error){  
    ...
    if(this.webRTCommClient.eventListener.onWebRTCommCallOpenErrorEvent)
    {
        ...
        setTimeout(function(){
            ...
            {
                console.error("WebRTCommCall:onRtcPeerConnectionErrorEvent(): caught exception in listener:"+exception);    
            }
        },1); 
    }
...
WebRTCommCall.prototype.onRtcPeerConnectionOnAddStreamEvent=function(event){
    ...
    {
        console.error("WebRTCommCall:onRtcPeerConnectionOnAddStreamEvent(): caught exception, exception:"+exception);
...
WebRTCommCall.prototype.onRtcPeerConnectionOnRemoveStreamEvent=function(event){
    ...
    {
        console.error("WebRTCommCall:onRtcPeerConnectionOnRemoveStreamEvent(): caught exception, exception:"+exception);
        this.onRtcPeerConnectionErrorEvent();
    }
}
...
WebRTCommCall.prototype.onRtcPeerConnectionIceCandidateEvent=function(rtcIceCandidateEvent){
                        ...
                        else if (this.peerConnectionState == 'preparing-answer') 
                        {
                            ...
                            if(this.webRTCommClient.eventListener.onWebRTCommCallOpenedEvent) 
                            {
                                ...
                                setTimeout(function(){
                                    ...
                                    {
                                        console.error("WebRTCommCall:onRtcPeerConnectionIceCandidateEvent(): caught exception in listener:"+exception);    
                                    }
                                },1); 
                            }
                        }
    ...
    {
        console.error("WebRTCommCall:onRtcPeerConnectionIceCandidateEvent(): caught exception, exception:"+exception);
...
WebRTCommCall.prototype.onRtcPeerConnectionCreateOfferSuccessEvent=function(sdpOffer){ 
    ...
    {
        console.error("WebRTCommCall:onRtcPeerConnectionCreateOfferSuccessEvent(): caught exception, exception:"+exception);
        this.onRtcPeerConnectionErrorEvent(); 
    }
}
...
WebRTCommCall.prototype.onRtcPeerConnectionCreateOfferErrorEvent=function(error){
    ...
    {
        console.error("WebRTCommCall:onRtcPeerConnectionCreateOfferErrorEvent(): caught exception, exception:"+exception);
        this.onRtcPeerConnectionErrorEvent();  
    }
}
...
WebRTCommCall.prototype.onRtcPeerConnectionSetLocalDescriptionSuccessEvent=function(){
                ...
                else if (this.peerConnectionState == 'preparing-answer') 
                {
                    ...
                    if(this.webRTCommClient.eventListener.onWebRTCommCallOpenedEvent) 
                    {
                        ...
                        setTimeout(function(){
                            ...
                            {
                                console.error("WebRTCommCall:onRtcPeerConnectionSetLocalDescriptionSuccessEvent(): caught exception in listener:"+exception);    
                            }
                        },1); 
                    }
                }
    ...
    {
        console.error("WebRTCommCall:onRtcPeerConnectionSetLocalDescriptionSuccessEvent(): caught exception, exception:"+exception);
        this.onRtcPeerConnectionErrorEvent();     
    }
}
...
WebRTCommCall.prototype.onRtcPeerConnectionSetLocalDescriptionErrorEvent=function(error){
    ...
    {
        console.error("WebRTCommCall:onRtcPeerConnectionSetLocalDescriptionErrorEvent(): caught exception, exception:"+exception);
        this.onRtcPeerConnectionErrorEvent();     
    }
}
...
WebRTCommCall.prototype.onRtcPeerConnectionCreateAnswerSuccessEvent=function(answer){
    ...
    {
        console.error("WebRTCommCall:onRtcPeerConnectionCreateAnswerSuccessEvent(): caught exception, exception:"+exception);
        this.onRtcPeerConnectionErrorEvent();     
    }  
}
...
WebRTCommCall.prototype.onRtcPeerConnectionCreateAnswerErrorEvent=function(error){
    ...
    {
        console.error("WebRTCommCall:onRtcPeerConnectionCreateAnswerErrorEvent(): caught exception, exception:"+exception);
        this.onRtcPeerConnectionErrorEvent();       
    }  
}
...
WebRTCommCall.prototype.onRtcPeerConnectionSetRemoteDescriptionSuccessEvent=function(){
            ...
            {            
                ...
                if(this.webRTCommClient.eventListener.onWebRTCommCallOpenedEvent) 
                {
                    ...
                    setTimeout(function(){
                        ...
                        {
                            console.error("WebRTCommCall:onRtcPeerConnectionSetRemoteDescriptionSuccessEvent(): caught exception in listener:"+exception);    
                        }
                    },1); 
                } 
            }
    ...
    {
        console.error("WebRTCommCall:onRtcPeerConnectionSetRemoteDescriptionSuccessEvent(): caught exception, exception:"+exception);
        this.onRtcPeerConnectionErrorEvent();      
    }
}
                    ...
                    else if (this.peerConnectionState == 'preparing-answer') 
                    {
                        ...
                        if(this.webRTCommClient.eventListener.onWebRTCommCallOpenedEvent) 
                        {
                            ...
                            setTimeout(function(){
                                ...
                                {
                                    console.error("WebRTCommCall:onRtcPeerConnectionGatheringChangeEvent(): caught exception in listener:"+exception);    
                                }
                            },1); 
                        }
                    }
        ...
        if(this.messageChannel)
        {
            ...
            if(this.webRTCommClient.eventListener.onWebRTCommCallMessageEvent)
            {
                ...
                setTimeout(function(){
                    ...
                    {
                        console.error("WebRTCommCall:onRtcPeerConnectionMessageChannelOnMessageEvent(): caught exception in listener:"+exception);    
                    }
                },1);
            }  
        }
...
WebRTCommCall.prototype.applyConfiguredCodecFilterOnSessionDescription=function(sessionDescription){ 
    if(sessionDescription instanceof SessionDescription)
    {
        ...
        {
            console.error("WebRTCommCall:applyConfiguredCodecFilterOnSessionDescription(): caught exception, exception:"+exception);
            throw exception;
        }
    }
    else 
...
WebRTCommCall.prototype.removeMediaDescription=function(sessionDescription, mediaTypeToRemove){ 
    ...
    if(sessionDescription instanceof SessionDescription)
    {
        ...
        {
            console.error("WebRTCommCall:removeMediaDescription(): caught exception, exception:"+exception);
            throw exception;
        }
    }
    else 
...
WebRTCommCall.prototype.forceTurnMediaRelay=function(sessionDescription){ 
    ...
    if(sessionDescription instanceof SessionDescription)
    {
        ...
        {
            console.error("WebRTCommCall:forceTurnMediaRelay(): caught exception, exception:"+exception);
            throw exception;
        }
    }
    else 
...
WebRTCommClient.prototype.close=function(){
    ...
    {    
        try
        {
            ...
            console.error("WebRTCommClient:close(): caught exception:"+exception);
            ...
            if(this.eventListener.onWebRTCommClientClosedEvent!=undefined) 
            {
                ...
                setTimeout(function(){
                    ...
                    {
                        console.error("WebRTCommClient:onWebRTCommClientClosed(): caught exception in event listener:"+exception);  
                    }
                },1);
            }
        } 
...
WebRTCommClient.prototype.call=function(calleePhoneNumber, callConfiguration){
    ...
    try
    {
        ...
        console.error("WebRTCommClient:call(): caught exception:"+exception);
        throw exception;  
    }  
}
    ...
    if(this.eventListener.onWebRTCommClientOpenedEvent!=undefined) 
    {
        ...
        setTimeout(function(){
            try{
                ...
                console.error("WebRTCommClient:onPrivateClientConnectorOpenedEvent(): caught exception in event listener:"+exception);
            }          
        },1);    
    }
}
    ...
    if(this.eventListener.onWebRTCommClientOpenErrorEvent!=undefined) 
    {
        ...
        setTimeout(function(){
            try{
                ...
                console.error("WebRTCommClient:onPrivateClientConnectorOpenErrorEvent(): caught exception in event listener:"+exception);
            }          
        },1); 
    }
} 
    ...
    if(wasOpenedFlag && this.eventListener.onWebRTCommClientClosedEvent!=undefined) 
    {
        ...
        setTimeout(function(){
            try{
                ...
                console.error("WebRTCommClient:onPrivateClientConnectorClosedEvent(): caught exception in event listener:"+exception);
            }          
        },1);  
    } 
    else  if(!wasOpenedFlag && this.eventListener.onWebRTCommClientOpenErrorEvent!=undefined) 
    {
        ...
        setTimeout(function(){
            try{
                ...
                console.error("WebRTCommClient:onWebRTCommClientOpenErrorEvent(): caught exception in event listener:"+exception);
            }          
        },1);  
    } 
}
