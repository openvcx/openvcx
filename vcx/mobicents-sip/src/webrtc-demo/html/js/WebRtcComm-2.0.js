            ...
            if(this.checkConfiguration(configuration))
            {
                if(this.isOpened()==false)
                {
                    try
                    {
                        ...
                        console.error("WebRtcCommCall:open(): caught exception:"+exception);
                        setTimeout(function(){
                            try {
                            ...
                            {
                                console.error("WebRtcCommCall:onPrivateCallConnectorCallOpenErrorEvent(): caught exception in listener:"+exception);    
                            }
                        },1);
            ...
            if(this.checkConfiguration(configuration))
            {
                ...
                if(this.isOpened()==false)
                {
                    try
                    {
                        ...
                        console.error("WebRtcCommCall:accept(): caught exception:"+exception);
                        // Close properly the communication
                        try {
                            this.close();
                        } catch(e) {} 
...
WebRtcCommCall.prototype.reject =function(){
    ...
    if(this.webRtcCommClient.isOpened())
    {
        ...
        {
            console.error("WebRtcCommCall:reject(): caught exception:"+exception);
            // Close properly the communication
            try {
                this.close();
            } catch(e) {}    
    ...
    if(this.webRtcCommClient.isOpened())
    {
        if(this.isOpened())
        {
            if(this.messageChannel && this.messageChannel.readyState=="open")
            {
                ...
                {
                    console.error("WebRtcCommCall:sendMessage(): caught exception:"+exception);
                    throw "WebRtcCommCall:sendMessage(): caught exception:"+exception; 
                }
            }
            else
            {
...
WebRtcCommCall.prototype.onPrivateCallConnectorRemoteSdpAnswerEvent=function(remoteSdpAnswer){
    ...
    {
        console.error("WebRtcCommCall:onPrivateCallConnectorRemoteSdpAnswerEvent(): caught exception:"+exception); 
        throw exception;  
    } 
} 
...
WebRtcCommCall.prototype.onPrivateCallConnectorCallOpenedEvent=function()
{
    ...
    if(this.webRtcCommClient.eventListener.onWebRtcCommCallOpenEvent)
    {
        ...
        setTimeout(function(){
            ...
            {
                console.error("WebRtcCommCall:onPrivateCallConnectorCallOpenedEvent(): caught exception in listener:"+exception);    
            }
        },1);
    }
}
...
WebRtcCommCall.prototype.onPrivateCallConnectorCallHangupEvent=function()
{
    ...
    if(this.webRtcCommClient.eventListener.onWebRtcCommCallHangupEvent)
    {
        ...
        setTimeout(function(){
            ...
            {
                console.error("WebRtcCommCall:onPrivateCallConnectorCallHangupEvent(): caught exception in listener:"+exception);    
            }
        },1);
    }  
}
...
WebRtcCommCall.prototype.processRtcPeerConnectionError=function(error){  
    ...
    if(this.webRtcCommClient.eventListener.onWebRtcCommCallOpenErrorEvent)
    {
        ...
        setTimeout(function(){
            ...
            {
                console.error("WebRtcCommCall:processRtcPeerConnectionError(): caught exception in listener:"+exception);    
            }
        },1); 
    }
...
WebRtcCommCall.prototype.processRtcPeerConnectionOnAddStream=function(event){
    ...
    {
        console.error("WebRtcCommCall:processRtcPeerConnectionOnAddStream(): caught exception, exception:"+exception);
...
WebRtcCommCall.prototype.onRtcPeerConnectionOnRemoveStreamEvent=function(event){
    ...
    {
        console.error("WebRtcCommCall:processRtcPeerConnectionOnRemoveStream(): caught exception, exception:"+exception);
        this.processRtcPeerConnectionError();
    }
}
...
WebRtcCommCall.prototype.onRtcPeerConnectionIceCandidateEvent=function(rtcIceCandidateEvent){
                        ...
                        else if (this.peerConnectionState == 'preparing-answer') 
                        {
                            ...
                            if(this.webRtcCommClient.eventListener.onWebRtcCommCallOpenedEvent) 
                            {
                                ...
                                setTimeout(function(){
                                    ...
                                    {
                                        console.error("WebRtcCommCall:processInvitingSipRequest(): caught exception in listener:"+exception);    
                                    }
                                },1); 
                            }
                        }
    ...
    {
        console.error("WebRtcCommCall:processRtcPeerConnectionIceCandidate(): caught exception, exception:"+exception);
...
WebRtcCommCall.prototype.processRtcPeerConnectionCreateOfferSuccess=function(sdpOffer){ 
    ...
    {
        console.error("WebRtcCommCall:processRtcPeerConnectionCreateOfferSuccess(): caught exception, exception:"+exception);
        this.processRtcPeerConnectionError(); 
    }
}
...
WebRtcCommCall.prototype.processRtcPeerConnectionCreateOfferError=function(error){
    ...
    {
        console.error("WebRtcCommCall:processRtcPeerConnectionCreateOfferError(): caught exception, exception:"+exception);
        this.processRtcPeerConnectionError();  
    }
}
...
WebRtcCommCall.prototype.processRtcPeerConnectionSetLocalDescriptionSuccess=function(){
                ...
                else if (this.peerConnectionState == 'preparing-answer') 
                {
                    ...
                    if(this.webRtcCommClient.eventListener.onWebRtcCommCallOpenedEvent) 
                    {
                        ...
                        setTimeout(function(){
                            ...
                            {
                                console.error("WebRtcCommCall:processRtcPeerConnectionSetLocalDescriptionSuccess(): caught exception in listener:"+exception);    
                            }
                        },1); 
                    }
                }
    ...
    {
        console.error("WebRtcCommCall:processRtcPeerConnectionSetLocalDescriptionSuccess(): caught exception, exception:"+exception);
        this.processRtcPeerConnectionError();     
    }
}
...
WebRtcCommCall.prototype.processRtcPeerConnectionSetLocalDescriptionError=function(error){
    ...
    {
        console.error("WebRtcCommCall:processRtcPeerConnectionSetLocalDescriptionError(): caught exception, exception:"+exception);
        this.processRtcPeerConnectionError();     
    }
}
...
WebRtcCommCall.prototype.processRtcPeerConnectionCreateAnswerSuccess=function(answer){
    ...
    {
        console.error("WebRtcCommCall:processRtcPeerConnectionCreateAnswerSuccess(): caught exception, exception:"+exception);
        this.processRtcPeerConnectionError();     
    }  
}
...
WebRtcCommCall.prototype.processRtcPeerConnectionCreateAnswerError=function(error){
    ...
    {
        console.error("WebRtcCommCall:processRtcPeerConnectionCreateAnswerError(): caught exception, exception:"+exception);
        this.processRtcPeerConnectionError();       
    }  
}
...
WebRtcCommCall.prototype.processRtcPeerConnectionSetRemoteDescriptionSuccess=function(){
            ...
            {            
                ...
                if(this.webRtcCommClient.eventListener.onWebRtcCommCallOpenedEvent) 
                {
                    ...
                    setTimeout(function(){
                        ...
                        {
                            console.error("WebRtcCommCall:processRtcPeerConnectionSetRemoteDescriptionSuccess(): caught exception in listener:"+exception);    
                        }
                    },1); 
                } 
            }
    ...
    {
        console.error("WebRtcCommCall:processRtcPeerConnectionSetRemoteDescriptionSuccess(): caught exception, exception:"+exception);
        this.processRtcPeerConnectionError();      
    }
}
                    ...
                    else if (this.peerConnectionState == 'preparing-answer') 
                    {
                        ...
                        if(this.webRtcCommClient.eventListener.onWebRtcCommCallOpenedEvent) 
                        {
                            ...
                            setTimeout(function(){
                                ...
                                {
                                    console.error("WebRtcCommCall:processRtcPeerConnectionGatheringChange(): caught exception in listener:"+exception);    
                                }
                            },1); 
                        }
                    }
        ...
        if(this.messageChannel)
        {
            ...
            if(this.webRtcCommClient.eventListener.onWebRtcCommCallMessageEvent)
            {
                ...
                setTimeout(function(){
                    ...
                    {
                        console.error("WebRtcCommCall:processRtcPeerConnectionMessageChannelOnMessage(): caught exception in listener:"+exception);    
                    }
                },1);
            }  
        }
...
WebRtcCommCall.prototype.applyConfiguredCodecFilterOnSessionDescription=function(sessionDescription){ 
    if(sessionDescription instanceof SessionDescription)
    {
        ...
        {
            console.error("WebRtcCommCall:applyConfiguredCodecFilterOnSessionDescription(): caught exception, exception:"+exception);
            throw exception;
        }
    }
    else 
...
WebRtcCommCall.prototype.removeMediaDescription=function(sessionDescription, mediaTypeToRemove){ 
    ...
    if(sessionDescription instanceof SessionDescription)
    {
        ...
        {
            console.error("WebRtcCommCall:removeMediaDescription(): caught exception, exception:"+exception);
            throw exception;
        }
    }
    else 
...
WebRtcCommClient.prototype.close=function(){
    ...
    {    
        try
        {
            ...
            console.error("WebRtcCommClient:close(): caught exception:"+exception);
            ...
            if(this.eventListener.onWebRtcCommClientClosedEvent!=undefined) 
            {
                ...
                setTimeout(function(){
                    ...
                    {
                        console.error("WebRtcCommClient:onWebRtcCommClientClosed(): caught exception in event listener:"+exception);  
                    }
                },1);
            }
        } 
...
WebRtcCommClient.prototype.call=function(calleePhoneNumber, callConfiguration){
    ...
    try
    {
        ...
        console.error("WebRtcCommClient:call(): caught exception:"+exception);
        throw exception;  
    }  
}
    ...
    if(this.eventListener.onWebRtcCommClientOpenedEvent!=undefined) 
    {
        ...
        setTimeout(function(){
            try{
                ...
                console.error("WebRtcCommClient:onPrivateClientConnectorOpenedEvent(): caught exception in event listener:"+exception);
            }          
        },1);    
    }
}
    ...
    if(this.eventListener.onWebRtcCommClientOpenErrorEvent!=undefined) 
    {
        ...
        setTimeout(function(){
            try{
                ...
                console.error("WebRtcCommClient:onPrivateClientConnectorOpenErrorEvent(): caught exception in event listener:"+exception);
            }          
        },1); 
    }
} 
    ...
    if(wasOpenedFlag && this.eventListener.onWebRtcCommClientClosedEvent!=undefined) 
    {
        ...
        setTimeout(function(){
            try{
                ...
                console.error("WebRtcCommClient:onPrivateClientConnectorClosedEvent(): caught exception in event listener:"+exception);
            }          
        },1);  
    } 
    else  if(!wasOpenedFlag && this.eventListener.onWebRtcCommClientOpenErrorEvent!=undefined) 
    {
        ...
        setTimeout(function(){
            try{
                ...
                console.error("WebRtcCommClient:onWebRtcCommClientOpenErrorEvent(): caught exception in event listener:"+exception);
            }          
        },1);  
    } 
}
