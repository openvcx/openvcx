...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-nonfree --enable-pthreads --enable-libvorbis --enable-libvpx
prefix=/usr/local
...
CC_IDENT=gcc 4.1.1 (GCC) 20061011 (Red Hat 4.1.1-30)
ARCH=x86
CC=gcc
CXX=g++
AS=gcc
...
EXTRALIBS=-ldl -lx264 -lvpx -lvorbisenc -lvorbis -logg -lm -pthread -lbz2 -lz 
INSTALL=install
LIBTARGET=
