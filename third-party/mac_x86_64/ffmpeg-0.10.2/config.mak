...
CC_IDENT=llvm-gcc 4.2.1 (LLVM build 2335.15.00)
ARCH=x86
CC=gcc
CXX=g++
...
EXTRALIBS= -lx264 -lvpx -lvpx -lvorbisenc -lvorbis -logg -lm -framework CoreFoundation -framework VideoDecodeAcceleration -framework QuartzCore -lbz2 -lz 
INSTALL=install
LIBTARGET=
