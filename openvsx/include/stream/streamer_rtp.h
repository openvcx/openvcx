...
typedef enum STREAMER_AUTH_IDX {
  ...
  STREAMER_AUTH_IDX_RTMP          = 1,
  STREAMER_AUTH_IDX_FLV           = 2,
  STREAMER_AUTH_IDX_MKV           = 3,
  STREAMER_AUTH_IDX_TSLIVE        = 4,
  STREAMER_AUTH_IDX_HTTPLIVE      = 5,
  STREAMER_AUTH_IDX_MOOFLIVE      = 6,
  STREAMER_AUTH_IDX_PIP           = 7,
  STREAMER_AUTH_IDX_STATUS        = 8,
  STREAMER_AUTH_IDX_CONFIG        = 9,
  STREAMER_AUTH_IDX_RTSPANNOUNCE  = 10,
  STREAMER_AUTH_IDX_RTMPPUBLISH   = 11,
  STREAMER_AUTH_IDX_ROOT          = 12,
  STREAMER_AUTH_IDX_MAX           = 13 
} STREAMER_IDX_AUTH_T;
