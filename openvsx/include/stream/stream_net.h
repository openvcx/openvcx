...
enum STREAM_NET_ADVFR_RC {
  ...
  STREAM_NET_ADVFR_RC_RESET_TMGAP = 2,
  STREAM_NET_ADVFR_RC_RESET_TMBKWD = 3,
  STREAM_NET_ADVFR_RC_NOCONTENT = 4,
  STREAM_NET_ADVFR_RC_NOTAVAIL = 5,
  STREAM_NET_ADVFR_RC_OVERWRITE  = 6,
  STREAM_NET_ADVFR_RC_NOTENCODED = 7
};
