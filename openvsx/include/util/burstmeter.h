...
#define THROUGHPUT_BYTES_IN_KILO            1024.0
#define THROUGHPUT_BYTES_IN_KILO_F          1024.0f
#define THROUGHPUT_BYTES_IN_MEG           (THROUGHPUT_BYTES_IN_KILO * THROUGHPUT_BYTES_IN_KILO) 
#define THROUGHPUT_BYTES_IN_MEG_F           (THROUGHPUT_BYTES_IN_KILO_F * THROUGHPUT_BYTES_IN_KILO_F) 
#define THROUGHPUT_BYTES_IN_GIG           (THROUGHPUT_BYTES_IN_MEG * THROUGHPUT_BYTES_IN_KILO) 
#define THROUGHPUT_BYTES_IN_GIG_F           (THROUGHPUT_BYTES_IN_MEG_F * THROUGHPUT_BYTES_IN_KILO_F) 
