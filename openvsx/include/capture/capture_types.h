...
typedef enum CAPTURE_FILTER_TRANSPORT {
  ...
  CAPTURE_FILTER_TRANSPORT_RTMPT       = 12,
  CAPTURE_FILTER_TRANSPORT_RTMPS       = 13,
  CAPTURE_FILTER_TRANSPORT_RTMPTS      = 14,
  CAPTURE_FILTER_TRANSPORT_DEV         = 15,
  CAPTURE_FILTER_TRANSPORT_HTTPFLV     = 16,
  CAPTURE_FILTER_TRANSPORT_HTTPSFLV    = 17,
  CAPTURE_FILTER_TRANSPORT_HTTPMP4     = 18,
  CAPTURE_FILTER_TRANSPORT_HTTPSMP4    = 19,
  CAPTURE_FILTER_TRANSPORT_HTTPDASH    = 20,
  CAPTURE_FILTER_TRANSPORT_HTTPSDASH   = 21,
...
#define IS_CAPTURE_FILTER_TRANSPORT_RTMP(t)  ((t) == CAPTURE_FILTER_TRANSPORT_RTMP \
                                       || (t) == CAPTURE_FILTER_TRANSPORT_RTMPT \
                                       || (t) == CAPTURE_FILTER_TRANSPORT_RTMPS \
                                       || (t) == CAPTURE_FILTER_TRANSPORT_RTMPTS)
